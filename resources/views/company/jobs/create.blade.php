                ...
                <form method="POST" action="{{ route('company.jobs.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <x-text-input id="title" class="block mt-1 w-full bg-slate-800/50 border-slate-700 text-white focus:border-indigo-500 focus:ring-indigo-500" type="text" name="title" :value="old('title')" required autofocus />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="4" class="block mt-1 w-full bg-slate-800/50 border-slate-700 text-white focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>{{ old('description') }}</textarea>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="requirements" name="requirements" rows="4" class="block mt-1 w-full bg-slate-800/50 border-slate-700 text-white focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>{{ old('requirements') }}</textarea>
                        ...
                        <div>
                            ...
                            <x-text-input id="location" class="block mt-1 w-full bg-slate-800/50 border-slate-700 text-white focus:border-indigo-500 focus:ring-indigo-500" type="text" name="location" :value="old('location')" placeholder="e.g. Cairo, Egypt or Remote" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="vacancies" class="block mt-1 w-full bg-slate-800/50 border-slate-700 text-white focus:border-indigo-500 focus:ring-indigo-500" type="number" min="1" name="vacancies" :value="old('vacancies', 1)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="experience_years" class="block mt-1 w-full bg-slate-800/50 border-slate-700 text-white focus:border-indigo-500 focus:ring-indigo-500" type="text" name="experience_years" :value="old('experience_years')" placeholder="e.g. 1-3 Years" required />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <x-text-input id="salary_range" class="block mt-1 w-full bg-slate-800/50 border-slate-700 text-white focus:border-indigo-500 focus:ring-indigo-500" type="text" name="salary_range" :value="old('salary_range')" placeholder="e.g. 10,000" />
